...
const HomePage = () => {
  return (
    <>
      <h2 className="py-3 text-2xl font-bold text-center bg-teal-300 border-b-2 border-b-gray-400">
        {authorInfo.headline}
      </h2>
      <div className="flex flex-col gap-10 px-6 py-10 lg:flex-row">
        <div className="sm:max-w-[20rem] flex flex-col items-center gap-5 sm:flex-row lg:flex-col sm:gap-10">
          <Image
            ...
            width={288}
            height={288}
            className="p-1 rounded-full outline outline-4 outline-teal-300 w-72 h-72"
          />
